...
public class WalkingMusicAnalyzer implements MusicAnalyzer {

    private static final String TAG = WalkingMusicAnalyzer.class.getSimpleName();
    ...
    public static final int INITIAL_STEPS_INETRVAL = 10;
    ...
    */
    ...
    public WalkingMusicAnalyzer(String note, String scale, int steps) {
        mBaseNote = Notes.valueOf(note);
    ...
    private void loadDefaultStepIntervals() {
        stepIntervals = new Integer[] { INITIAL_STEPS_INETRVAL, 20, 30, 50, 100 };
    }
    ...
    @Override
    public void setBaseNote(Notes newNote) {
        mBaseNote = newNote;
    }
    ...
    @Override
    public void setScale(Scales newScale) {
        mScale = newScale;
    }
    ...
    public void setStepsInterval(int newStepsInterval) {
        mStepsInterval = newStepsInterval;
    }
