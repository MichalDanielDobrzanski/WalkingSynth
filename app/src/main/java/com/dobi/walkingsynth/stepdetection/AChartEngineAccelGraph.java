...
public class AChartEngineAccelGraph implements AccelGraph {
    ...
    public static final String TAG = AChartEngineAccelGraph.class.getSimpleName();
    ...
    private double getAccelerometerValue() {
        return AccelerometerProcessing.getInstance().getAccelerometerCurrentValue() - OFFSET;
    }

    private double getThresholdValue() {
        return AccelerometerProcessing.getInstance().getThreshold() - OFFSET;
    }
